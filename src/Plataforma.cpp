...
Plataforma::Plataforma(Vector2f tam) {
    ...
    if (tam.x < 500.0f) { corpo.setTextura("../Texturas/Plataforma/PlatGramaP.png"); }
    else if (tam.x < 1000.0f) { corpo.setTextura("../Texturas/Plataforma/PlatGramaM.png"); }
    else { corpo.setTextura("../Texturas/Plataforma/PlatGramaG.png"); }
